...
static void axp192_monitor_task(void *pvParameters)
{
    ...
    while (1) {
        ...
        // === 🎛️ M5StickC Plus硬件电源管理演示 ===
        static int demo_cycle = 0;
        demo_cycle = (demo_cycle + 1) % 4;
        
        ESP_LOGI(TAG, "=== 🎛️ 电源管理演示 (周期 %d/4) ===", demo_cycle + 1);
...
void app_main(void)
{
    ...
    if (ret != ESP_OK) {
        ...
        // 创建AXP192监控任务
        xTaskCreate(axp192_monitor_task, "axp192_monitor", 2048, NULL, 5, NULL);
    }
