...
esp_err_t lvgl_init_with_m5stick_lcd(void)
{
    ...
    spi_bus_config_t buscfg = {
        ...
        .quadwp_io_num = -1,
        .quadhd_io_num = -1,
        .max_transfer_sz = ST7789_LCD_H_RES * 80 * sizeof(uint16_t), // Transfer 80 lines at a time
    };
    ...
    esp_lcd_panel_dev_config_t panel_config = {
        ...
        .rgb_ele_order = LCD_RGB_ELEMENT_ORDER_BGR,  // Back to BGR for M5StickC Plus
        .bits_per_pixel = 16,
    };
    ...
    ESP_ERROR_CHECK(axp192_power_tft_backlight(true));
    ...
    ESP_LOGI(TAG, "Create demo UI");
    // _lock_acquire(&lvgl_api_lock);  // Simplified for now
    m5stick_lvgl_demo_ui(display);
    // _lock_release(&lvgl_api_lock);  // Simplified for now
